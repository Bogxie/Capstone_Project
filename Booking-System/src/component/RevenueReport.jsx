...
export const RevenueReport = ({ bookings }) => {
    ...
    // ✅ FIXED: "Completed" hindi "Complete"
    ...
    return (
        // 🎨 Design update - dark theme with lime accents
        <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-4 mb-4">
            <h3 className="text-lime-400 font-bold text-sm mb-3">📊 Revenue Report</h3>

            <div className="flex flex-wrap items-center gap-2 mb-2">
                <select
                    value={scope}
                    onChange={(e) => setScope(e.target.value)}
                    className="bg-zinc-800 border border-zinc-700 text-white text-sm rounded-lg px-3 py-1.5 focus:border-lime-500 focus:outline-none"
                >
                ...
                <button
                    ...
                    className="ml-auto px-4 py-1.5 text-sm font-bold rounded-lg bg-lime-500 text-black hover:bg-lime-400 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
                    🖨️ Print Report
                </button>
            </div>
